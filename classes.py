...
class Metrics:
    def __init__(self):
        ...
        # Cumulative runtime for 1st 'neighborhood' was used
        self.CumulativeRuntimeFirstNeighborhood = 0.0

        # Number of iterations in which 2nd 'neighborhood' was used
        self.NumItersSecondNeighborhood = 0

        # Cumulative runtime for 2nd 'neighborhood' was used
        self.CumulativeRuntimeSecondNeighborhood = 0.0

        # Number of iterations in which 3rd 'neighborhood' was used
        self.NumItersThirdNeighborhood = 0
